...
<head>
  ...
  <title>Admin Approval(art)</title>
	...
	<div class="main-container"> 
        ...
        <div class="report-container"> 
            <div class="report-header"> 
                <h1 class="recent-Articles">Registration Form Request(Art Club)</h1> 
            ...
            <div class="report-body"> 
                <table>
                    ...
                    <?php   include('../config/dbase.php');
                        ...
                        $query="SELECT * FROM student where status='PENDING' AND club_name='art club'"; 
                        if($result = mysqli_query($con, $query)){
                          while ($row = mysqli_fetch_array($result)){
                            ...
                            <td>
                            <form action="adminApproval(art).php" method="post">
