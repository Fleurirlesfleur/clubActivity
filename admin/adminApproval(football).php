...
<head>
  ...
  <title>Admin Approval(football club)</title>
	...
	<div class="main-container"> 
        ...
        <div class="report-container"> 
            <div class="report-header"> 
                <h1 class="recent-Articles">Registration Form Request(Football Club)</h1> 
                ...
                <table>
                    ...
                    <tbody>
                      <?php   include('../config/dbase.php');
                        ...
                        $query="SELECT * FROM student where status='PENDING' AND club_name='football club'"; 
                        if($result = mysqli_query($con, $query)){
                          while ($row = mysqli_fetch_array($result)){
                            ...
                            <td>
                              <form action="adminApproval(football).php" method="post">
                      ...
                      ?>
                       <!-- <tr>
                            ...
                            <td>Second year</td>
                            <td>CS</td>
                            <td><button class="approvebtn" ><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="#582761" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
