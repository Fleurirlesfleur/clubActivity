...
<head>
  ...
  <title>Admin Approval(photo club)</title>
	...
	<div class="main-container"> 
        ...
        <div class="report-container"> 
            <div class="report-header"> 
                <h1 class="recent-Articles">Registration Form Request(Photo Club)</h1> 
            ...
            <div class="report-body"> 
                <table>
                    ...
                    <?php   include('../config/dbase.php');
                        ...
                        $query="SELECT * FROM student where status='PENDING' AND club_name='photo club'"; 
                        if($result = mysqli_query($con, $query)){
                          while ($row = mysqli_fetch_array($result)){
                            ...
                            <td>
                            <form action="adminApproval(photo).php" method="post">
