...
<html lang="en">
  ...
  <body>
	...
	<div class="main-container"> 
      ...
      <h1 class="headOfTable">Art Club</h1>
      <div class="announcement-box">
        <h1>Create Memories</h1>
        <form action="adminArt.php" method="post">
            <label for="announcement-header">From:</label>
                          <input type="text" id="announcement-header" value="Art Club" name="title" required><br>
      ...
      <div class="secmain"> 
        ...
        <div class="announcement-box">
            ...
            <form action="#" method="post">
                <label for="announcement-header">From:</label>
                <input type="text" id="announcement-header" value="Art club" placeholder="Art club" name="header" required><br>
