...
<html lang="en">
  ...
  <body>
	...
	<div class="main-container"> 
      ...
      <h1 class="headOfTable">Photo Club</h1>
      <div class="announcement-box">
      <form action="adminPhoto.php" method="post">
            <label for="announcement-header">From:</label>
                          <input type="text" id="announcement-header" value="Photo Club" name="title" required><br>
...
<br>
    <table class="delTable">
        ...
        <tbody>
          <?php
            include("../config/dbase.php");
              $sql = "SELECT * FROM student where club_name='photo club' AND status='MEMBER'";
      ...
      <div class="secmain"> 
        ...
        <div class="announcement-box">
            ...
            <form action="#" method="post">
                <label for="announcement-header">From:</label>
                <input type="text" id="announcement-header" value="Photo club" placeholder="Photo club" name="announcement-header" required><br>
